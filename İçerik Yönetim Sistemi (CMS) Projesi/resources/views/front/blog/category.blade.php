...
@section('seo')
    <title>{{ \App\Models\LanguageContent::getTitle(BLOG_CATEGORY_LANGUAGE,$categoryId) }}</title>
    <meta name="description" content="{{ \App\Models\LanguageContent::getDescription(BLOG_CATEGORY_LANGUAGE,$categoryId) }}">
    <meta name="keywords" content="{{ \App\Models\LanguageContent::getKeywords(BLOG_CATEGORY_LANGUAGE,$categoryId) }}">
    @endsection
@section('content')
    ...
    <div class="pager-header">
        <div class="container">
            <div class="page-content">
                <h2>{{\App\Models\LanguageContent::getName(BLOG_CATEGORY_LANGUAGE,$categoryId)}}</h2>
                <ol class="breadcrumb">
