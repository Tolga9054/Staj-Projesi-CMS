  ...
  public function data(Request $request){
      ...
      $data = DataTables::of($query)
        ->addColumn('image',function($query){
          return '<img style="width:120px;" src = "'.asset(\App\Models\LanguageContent::get(DEFAULT_LANGUAGE,SLIDER_LANGUAGE,IMAGE_LANGUAGE,$query->id)).'">';
        })
        ->addColumn('edit',function($query){
          return '<a href="'.route('admin.slider.edit',['id'=>$query->id]).'">Düzenle';
        })
        ->addColumn('delete',function ($query){
          return '<a href="'.route('admin.slider.delete',['id'=>$query->id]).'">Sil';
        })
