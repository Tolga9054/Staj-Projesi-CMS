    ...
    <div class="peers ai-s fxw-nw h-100vh">
      ...
      <div class="col-12 col-md-4 peer pX-40 pY-80 h-100 bgc-white scrollable pos-r" style="min-width:320px">
        ...
        <form action="/login" method="post">
          @csrf
          <div class="form-group"><label class="text-normal text-dark">E-mail</label><input type="email" class="form-control" name="email"></div>
          <div class="form-group"><label class="text-normal text-dark">Şifre</label><input type="password" class="form-control" name="password"></div>
          <div class="form-group">
            <div class="peers ai-c jc-sb fxw-nw">
              <div class="peer"><button class="btn btn-primary">Giriş</button></div>
            </div>
          </div>
        </form>
      </div>
