...
<!--[if gt IE 8]><!--> <html class="no-js" lang="{{ \App\Helper\mHelper::getLanguageCode() }}"> <!--<![endif]-->
    <head>
        ...
        @foreach(\App\Models\Language::where('code','!=','tr')->get() as $k => $v)
            ...
            <div class="top-header">
                <div class="container">
                    <div class="top-content-wrap row">
                        <div class="col-md-8">
                            <ul class="left-info">
                                <li><a><i class="ti-email"></i>{{ $settings[0]["email"]}}</a></li>
                                <li><a><i class="ti-mobile"></i>{{ $settings[0]["phone"] }}</a></li>
                            </ul>
                        </div>
                       ...
                       <div class="col-md-9 d-none d-md-block text-right">
                           <ul id="mainmenu" class="nav navbar-nav nav-menu">
                                ...
                                <li><a href="#">@lang("general.pages")</a>
                                   <ul>
                                       @foreach(\App\Models\Page::where('isShow',ACTIVE)->orderBy('orderNumber','asc')->get() as $k => $v )
                                           <li><a href="{{ route('front.page.index',['slug'=>\App\Models\LanguageContent::getSlug(PAGE_LANGUAGE,$v['id'])]) }}">{{\App\Models\LanguageContent::getName(PAGE_LANGUAGE,$v['id'])}}</a></li>
                                       @endforeach
                                   </ul>
                                </li>
                                <li><a href="#">@lang("general.services")</a>
                                    <ul>
                                        @foreach(\App\Models\Services::orderBy('orderNumber','asc')->get() as $k => $v )
                                        <li><a href="{{ route('front.service.index',['slug'=>\App\Models\LanguageContent::getSlug(SERVICE_LANGUAGE,$v['id'])]) }}">{{\App\Models\LanguageContent::getName(SERVICE_LANGUAGE,$v['id'])}}</a></li>
                                        @endforeach
                                    </ul>
            ...
            <div class="widget-wrap row">
                <div class="col-lg-3 col-md-6 col-sm-6 sm-padding">
                    <div class="widget-content">
                        ...
                        <p>{!! \App\Models\LanguageContent::get(\App\Helper\mHelper::getLanguageId(),SITE_SETTING_LANGUAGE,FOOTER_TEXT_LANGUAGE,1) !!}</p>


                        <ul class="social-icon">
                            <li><a href="{{ $settings[0]["facebook"] }}"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="{{ $settings[0]["twitter"] }}"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="{{ $settings[0]["pinterest"] }}"><i class="fa fa-pinterest"></i></a></li>
                            <li><a href="{{ $settings[0]["instagram"] }}"><i class="fa fa-instagram"></i></a></li>
                            <li><a href="{{ $settings[0]["linkedin"] }}"><i class="fa fa-linkedin"></i></a></li>
                            <li><a href="{{ $settings[0]["youtube"] }}"><i class="fa fa-youtube"></i></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 sm-padding">
                    <div class="widget-content">
                        ...
                        <ul class="widget-link">
                            @foreach(\App\Models\Services::where('isHome',ACTIVE)->orderBy('orderNumber','asc')->get() as $k=>$v)
                                <li><a href="{{route('front.service.index',['slug'=>\App\Models\LanguageContent::getSlug(SERVICE_LANGUAGE,$v['id'])])}}">{{\App\Models\LanguageContent::getName(SERVICE_LANGUAGE,$v['id'])}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 sm-padding">
                    <div class="widget-content">
                        ...
                        <ul class="widget-link">
                            @foreach(\App\Models\Blog::where('isShow',ACTIVE)->get() as $k=>$v)
                                <li><a href="{{route('front.blog.index',['slug'=>\App\Models\LanguageContent::getSlug(BLOG_LANGUAGE,$v['id'])])}}">{{\App\Models\LanguageContent::getName(BLOG_LANGUAGE,$v['id'])}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
  ...
  <div class="container">
            <div class="row">
                <div class="col-md-6 sm-padding">
                    <div class="copyright">&copy; {{date("Y")}} Venox Powered by AlexaTheme</div>
                </div>
                <div class="col-md-6 sm-padding">
